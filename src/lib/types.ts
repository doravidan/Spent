  ...
  },
  {
    ...
    credentialFields: [
      ...
      { key: "password", label: "Password", type: "password" },
      {
        ...
        hint: "This is the user identification code from the Discount login form — not your bank account number.",
        numeric: true,
      },
    ],
    enabled: true,
  },
  {
    ...
    credentialFields: [
      ...
      { key: "password", label: "Password", type: "password" },
      {
        ...
        hint: "This is the user identification code from the Mercantile login form — not your bank account number.",
        numeric: true,
      },
    ],
    enabled: true,
